...
namespace Jonas_Sage_Importer{
    public partial class RadForm1 : RadForm{
        ...
        private void GpExcelFileFindFileOk(object sender, CancelEventArgs e){
            ...
            uxExcelSheetViewerGv.DataSource = null;
            uxExcelSheetViewerGv.Rows.Clear();
        ...
        private void ImportGreatPlains(){
            ...
            //Saving to temporary table for further manipulation
            try{
                radLabelElement1.Text = ($"Attempting to Import {uxImportTypeCmbo.Text} from Application.");
                Jonas.ImportGpToTemporaryTable(gridProcedureName, Table, uxImportSourceCmbo.Text);
            }
            ...
            try{
                ...
                Jonas.ImportGpToMainTable(tempProcedureName, uxImportSourceCmbo.Text);
        ...
        private void ImportCrm(){
            ...
            if (uxImportTypeCmbo.SelectedIndex == 0){
                ...
                if (!(Table.Columns.Count == 14 || Table.Columns.Count == 21 || Table.Columns.Count == 22 || Table.Columns.Count == 23)){
