namespace BL_JonasSageImporter {
    ...
    public partial class EF_JonasLedgerManager : DbContext {
        public EF_JonasLedgerManager()
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder) {
            modelBuilder.Entity<AdminStatus>()
                .Property(e => e.AdminStatusName)
                .IsUnicode(false);

            modelBuilder.Entity<CostOfGoodsSold>()
                .Property(e => e.CogsGPCode)
                .IsUnicode(false);

            modelBuilder.Entity<CostOfGoodsSold>()
                .Property(e => e.CogsItemQuantity)
                .HasPrecision(18, 0);

            modelBuilder.Entity<CostOfGoodsSold>()
                .Property(e => e.CogsItemListPrice)
                .HasPrecision(19, 4);

            modelBuilder.Entity<CostOfGoodsSold>()
                .Property(e => e.CogsItemBuyPrice)
                .HasPrecision(19, 4);
            ...
            modelBuilder.Entity<GP_Temp_OutstandingInvoices>()
            ...
            modelBuilder.Entity<Sage_Temp_InvoiceLedger>()
            ...
            modelBuilder.Entity<SaleLedger>()
                .Property(e => e.SiteSurveyDate)
                .IsUnicode(false);

            modelBuilder.Entity<SaleLedger>()
                .Property(e => e.BacklogComments)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<Temp_OrderLedger>()
            ...
            modelBuilder.Entity<TerminalType>()
                .Property(e => e.TerminalTypeName)
                .IsUnicode(false);
